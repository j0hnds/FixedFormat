...
public class DateTimeUtils {
    ...
    public static final Date parseDate(String dateString, String formatString) {
        ...
        if (TextUtils.isBlank(dateString)) {
            throw new IllegalArgumentException(
                    "Date to parse must be non-null, non-empty");
        }

        if (TextUtils.isBlank(formatString)) {
            throw new IllegalArgumentException(
                    "Format string must be non-null, non-empty");
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("Cannot parse date string ["
                    + dateString + "] with format string [" + formatString
                    + "]", e);
        }
    ...
    public static final String formatDate(Date date, String formatString) {
        ...
        if (TextUtils.isBlank(formatString)) {
            throw new IllegalArgumentException(
                    "Must specify a non-null, non-empty format string");
        }
